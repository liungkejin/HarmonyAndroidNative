...
#pragma once
#ifndef DIRECTSHOW_CAMERA__DIRECTSHOW_CAMERA__DIRECTSHOW_CAMERA_STUB_DEFAULT_H
#define DIRECTSHOW_CAMERA__DIRECTSHOW_CAMERA__DIRECTSHOW_CAMERA_STUB_DEFAULT_H
