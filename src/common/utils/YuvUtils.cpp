...
void YuvUtils::rgbaToNV21(uint8_t *src, int width, int height, uint8_t *dst) {
...
void YuvUtils::scaleNV21(uint8_t *src, int width, int height, uint8_t *dst, int dstWidth, int dstHeight, uint8_t *tempMem, int filterType) {
